    ...
    return (
        <div id="information-first" className="bg-dark-purple my-10 -z-10 relative">
            <div className="bg-white p-3 mx-[15%] h-[100%] xl:h-[90%] relative top-[-100px] lg:top-[-15%] rounded-3xl shadow-2xl pb-10 lg:pb-7">
                <h2 className="text-center py-4 font-extrabold text-dark-purple text-2xl">Lorem Ipsum</h2>
                <div className="flex flex-col lg:flex-row px-0 md:px-12 pt-8 lg:px-9  lg:pt-20 gap-5 lg:gap-12">
                    <div className="bg-young-purple w-full lg:w-[30%] p-5 relative rounded-2xl shadow-xl text-white">
                        ...
                        <div className="ml-4 md:ml-16 lg:ml-0">
                            <h4 className="text-left lg:text-center lg:mt-5 mb-3 font-bold">Sub Bab 1</h4>
                            <p className="text-sm text-justify">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo, iusto animi molestiae ipsam, v
                            </p>
                        </div>
                    </div>
                    <div className="bg-young-purple w-full lg:w-[30%] p-5 relative rounded-2xl shadow-xl text-white">
                        ...
                        <div className="mr-4 md:mr-16 lg:mr-0">
                            <h4 className="text-right lg:text-center lg:mt-5 mb-3 font-bold">Sub Bab 1</h4>
