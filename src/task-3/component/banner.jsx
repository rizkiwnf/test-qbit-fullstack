            ...
            <div className="text-dark-purple max-w-[563px] px-8 sm:px-16 md:px-0 lg:pl-[130px]">
                ...
                <div className="flex flex-col md:flex-row gap-4 items-center">
                    <div className="flex relative mt-5 -z-10 w-full">
                        ...
                        <input class="h-12 border-2 w-full rounded-full px-5 leading-tight focus:outline-none focus:bg-white focus:border-young-purple text-gray-400 focus:text-gray-700 ease-in-out duration-300" type="text" placeholder="email" />
                    </div>
                    ...
                    <button className="bg-young-purple py-3 w-full md:w-52 mt-2 md:mt-6 rounded-full text-white hover:ease-in-out duration-200 hover:bg-dark-purple">Get Started</button>
                </div>
            </div>
            <div className="">
