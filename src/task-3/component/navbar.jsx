        ...
        <div className="fixed w-full bg-white">
            <div className="mx-4 z-2 py-5">
                ...
                <h1 className="text-3xl font-extrabold text-white">Na<span className="text-yellow-500">mora</span></h1>
                    ...
                    <div className={!nav ? 'fixed md:hidden left-0 top-0 w-[50%] border-r-gray-50 h-full bg-young-purple ease-in-out duration-500 z-50' : 'fixed left-[-100%] top-0 w-[50%] border-r-gray-50 h-full ease-in-out duration-500'}>
